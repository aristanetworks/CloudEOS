...
vtep_ip_cidr          = "172.16.70.0/24" // CIDR block for VTEP IPs
terminattr_ip_cidr    = "172.16.71.0/24" // Loopback IP range for CloudVision connectivity
dps_controlplane_cidr = "172.16.72.0/24" // CIDR block for VXLAN/Dps Control Plane IPs
...
vpc_info = {
  edge1_vpc = {
    ...
    subnet_cidr = ["10.0.0.0/24", "10.0.1.0/24", "10.0.2.0/24", "10.0.3.0/24","10.0.4.0/24"]
    interface_ips = ["10.0.0.101","10.0.1.101","10.0.2.101","10.0.3.101","10.0.4.101"]
   }
  leaf1_vpc = {
