...
module "East2EdgeVpc" {
  ...
  cidr_block    = ["${var.east2_edge_cidr_block}"]
  tags = {
...
module "East2EdgeSubnet" {
  ...
  subnet_zones = {
    "${var.east2_edge_subnet0}" = lookup(module.globals.availability_zone[module.East2EdgeVpc.region], "zone1", "")
    "${var.east2_edge_subnet1}" = lookup(module.globals.availability_zone[module.East2EdgeVpc.region], "zone1", "")
    "${var.east2_edge_subnet2}" = lookup(module.globals.availability_zone[module.East2EdgeVpc.region], "zone2", "")
    "${var.east2_edge_subnet3}" = lookup(module.globals.availability_zone[module.East2EdgeVpc.region], "zone2", "")
  }
  subnet_names = {
    "${var.east2_edge_subnet0}" = "${module.globals.topology}-East2EdgeSubnet0"
    "${var.east2_edge_subnet1}" = "${module.globals.topology}-East2EdgeSubnet1"
    "${var.east2_edge_subnet2}" = "${module.globals.topology}-East2EdgeSubnet2"
    "${var.east2_edge_subnet3}" = "${module.globals.topology}-East2EdgeSubnet3"
  }
...
module "East2CloudEOSEdge1" {
  ...
  private_ips       = { "0" : ["${var.east2_edge1_intf0}"], "1" : ["${var.east2_edge1_intf1}"]}
...
module "East2CloudEOSEdge2" {
  ...
  private_ips       = { "0" : ["${var.east2_edge2_intf0}"], "1" : ["${var.east2_edge2_intf1}"] }
