...
vtep_ip_cidr          = "172.16.40.0/24" // CIDR block for VTEP IPs
terminattr_ip_cidr    = "172.16.41.0/24" // Loopback IP range for CloudVision connectivity
dps_controlplane_cidr = "172.16.42.0/24" // CIDR block for VXLAN/Dps Control Plane IPs
