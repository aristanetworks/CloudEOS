...
vpc_info = {
  ...
  region2_leaf1_vpc =  {
    ...
    subnet_cidr = ["101.2.0.0/24", "101.2.1.0/24"]
    interface_ips = ["101.2.0.101", "101.2.1.101", "101.2.1.102"]
  }
  region2_leaf2_vpc =  {
    vpc_cidr = "102.2.0.0/16"
    subnet_cidr = ["102.2.0.0/24", "102.2.1.0/24"]
    interface_ips = ["102.2.0.101", "102.2.1.101", "102.2.1.102"]
  }
  region3_leaf1_vpc =  {
