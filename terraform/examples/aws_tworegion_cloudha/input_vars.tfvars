...
vpc_info = {
  ...
  region2_leaf1_vpc =  {
    ...
    interface_ips = ["10.1.0.101", "10.1.1.101", "10.1.1.102", "10.1.2.101", "10.1.3.101", "10.1.3.102"]
  }
  region2_leaf2_vpc =  {
    vpc_cidr = "10.4.0.0/16"
    subnet_cidr = ["10.4.0.0/24", "10.4.1.0/24", "10.4.2.0/24", "10.4.3.0/24"]
    interface_ips = ["10.4.0.101", "10.4.1.101", "10.4.1.102", "10.4.2.101", "10.4.3.101", "10.4.3.102"]
  }
  region3_leaf1_vpc =  {
    vpc_cidr = "10.5.0.0/16"
    subnet_cidr = ["10.5.0.0/24", "10.5.1.0/24", "10.5.2.0/24", "10.5.3.0/24"]
    interface_ips = ["10.5.0.101", "10.5.1.101", "10.5.1.102", "10.5.2.101", "10.5.3.101", "10.5.3.102"]
  }
  region3_leaf2_vpc =  {
    vpc_cidr = "10.6.0.0/16"
    subnet_cidr = ["10.6.0.0/24", "10.6.1.0/24", "10.6.2.0/24", "10.6.3.0/24"]
    interface_ips = ["10.6.0.101", "10.6.1.101", "10.6.1.102", "10.6.2.101", "10.6.3.101", "10.6.3.102"]
  }
}
