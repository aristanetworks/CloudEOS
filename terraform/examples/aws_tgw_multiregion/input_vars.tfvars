...
vtep_ip_cidr          = "172.16.30.0/24" // CIDR block for VTEP IPs
terminattr_ip_cidr    = "172.16.31.0/24" // Loopback IP range for CloudVision connectivity
dps_controlplane_cidr = "172.16.32.0/24" // CIDR block for VXLAN/Dps Control Plane IPs
...
vpc_info = {
  region3_edge_vpc =  {
    ...
    subnet_cidr = ["10.3.0.0/24", "10.3.1.0/24", "10.3.2.0/24", "10.3.3.0/24", "10.3.4.0/24"]
    interface_ips = ["10.3.0.101", "10.3.1.101", "10.3.2.101", "10.3.3.101", "10.3.4.101"]
  }
  region3_leaf1_vpc =  {
    vpc_cidr = "10.2.0.0/16"
    subnet_cidr = ["10.2.0.0/24", "10.2.1.0/24"]
    interface_ips = ["10.2.0.101", "10.2.1.101", "10.2.1.102"]
  }
  region3_leaf2_vpc = {
